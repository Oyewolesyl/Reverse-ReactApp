    ...
    <div className="mobile-container">
      <header className="header">
        ...
        <button className="menu-button">
          ...
          <img src="/public/assets/menu_24px.svg" width="32" height="32" alt="Menu" />
        </button>
      </header>
      ...
      <main className="main-content">
        <div className="video-container">
          <video controls className="feature-video">
            {/* Video source - replace with your video */}
      ...
      <nav className="bottom-nav">
        <Link to="/" className="nav-item active">
          <img src="/public/assetshome-icon-active- (1).svg" width="32" height="32" alt="" />
          <span>Home</span>
        </Link>
